...
fn main() {
    ...
    if target_os == "macos" {
        ...
        let source_files = [manifest_dir.join("bindings").join("app_switch_detector.m")];
        ...
        let status = std::process::Command::new("clang")
            ...
            .args(&[
                ...
                "-o",
                out_path
                    .join("libapp_switch_detector.dylib")
                    .to_str()
                    .unwrap(),
            ])
            .status()
        ...
        println!("cargo:rustc-link-lib=app_switch_detector");
