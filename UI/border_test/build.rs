...
fn main() {
    ...
    if target_os == "macos" {
        ...
        let source_files = [manifest_dir.join("bindings").join("border_test.m")];
        ...
        let status = std::process::Command::new("clang")
            ...
            .args(&[
                ...
                "-o",
                out_path.join("libborder_test.dylib").to_str().unwrap(),
            ])
            .status()
        ...
        println!("cargo:rustc-link-lib=border_test");
